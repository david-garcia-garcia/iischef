    ...
    public class BindingRedirectHandler
    {
        ...
        protected static Assembly CurrentDomain_BindingRedirect(object sender, ResolveEventArgs args)
        {
            ...
            switch (name.Name)
            {
                ...
                case "ACMESharp.PKI.Providers.OpenSslLib":
                    return LoadAssembly(Environment.Is64BitProcess ? "ACMESharp.PKI.Providers.OpenSslLib64.dll" : "ACMESharp.PKI.Providers.OpenSslLib32.dll");
