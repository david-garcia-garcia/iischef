...
{
    public class StringFunctions : SingletonedClass<StringFunctions>
    {
        public class StringProcessing : SingletonedClass<StringProcessing>
        {
        ...
        /// Use for small to medium strings
        /// </summary>
        public class StringBuilderProcessing : SingletonedClass<StringBuilderProcessing>
        {
        ...
        public string AlternateCases(string input)
        {
            ...
            if (input.Length == 1)
            {
                return input; // Cannot automatically alternate
            }
        ...
        {
            if (input.Length - index - 1 >= input.Length || input.Length - index - 1 < 0)
            {
                return new char();
            }
